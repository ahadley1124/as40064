...
pub fn about() -> Html {
    ...
    <>
        ...
        <div class="about">
            ...
            <ul>
                <li>{ "Open peering: All networks with AMPR address space (44/9, 44.128/10) are welcome to peer. Any other networks will be evaluated before peering." }</li>
                <li>{ "No commercial traffic: The exchange is strictly for amateur radio and research purposes. Transit providers will be allowed on a case by case basis and subject to voting by the members." }</li>
